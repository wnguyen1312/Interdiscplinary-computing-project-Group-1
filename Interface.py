...
p1,=ax1.plot(list_degree,W1[1],color='g',label='area of glass')
ax2=ax1.twinx()
p2,=ax2.plot(list_degree,W2[1],color='b',label='area of CR-39')
ax3=ax1.twinx()
p3,=ax3.plot(list_degree,W3[1],color='r',label='area of 1.60MR-6')
ax3.spines['right'].set_position(('outward',40))
ax1.legend(['area of glass','area of CR-39','area of 1.60MR-6'])
plt.xlabel("degree of myopia")
plt.ylabel("area of the glasses")
plt.grid()
ax1.legend(handles=[p1,p2,p3])
plt.show()
fig,ax1=plt.subplots()
p1,=ax1.plot(list_degree2,W1[0],color='g',label='area of glass')
ax2=ax1.twinx()
p2,=ax2.plot(list_degree2,W2[0],color='b',label='area of CR-39')
ax3=ax1.twinx()
p3,=ax3.plot(list_degree2,W3[0],color='r',label='area of 1.60MR-6')
ax3.spines['right'].set_position(('outward',40))
...
ax1.legend(handles=[p1,p2,p3])
plt.show()
plt.plot(list_degree2,W1[0],label='area of glass')
plt.plot(list_degree2,W2[0],label='area of CR-39')
plt.plot(list_degree2,W3[0],label='area of 1.60MR-6')
plt.xlabel("degree of myopia")
plt.ylabel("area of the glasses")
plt.grid()
plt.legend()
